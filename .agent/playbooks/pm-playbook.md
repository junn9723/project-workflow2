...
12. **プロジェクト開始時・フェーズ移行時に `/find-skills` を実行し、作業に活用できる Skill を調査・インストール提案する**
13. **チームメンバーに対し、軽微な作業を除き該当する Skill の積極的な使用を指示する**
...
- **`/find-skills` の実行** — プロジェクトに有用な Skill の調査・インストール
